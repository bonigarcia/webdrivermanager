...
| ``forceOperativeSystem(OperativeSystem operativeSystem)`` | By default, WebDriverManager downloads the binary for the same operative systems than the machine running the test. This can be changed using this method (accepted values: ``WIN``, ``LINUX``, ``MAC``.                                                                                                                                                        | TODO                                                                                                                                                                      |
...
| ``useTaobaoMirror()``                                     | The [npm.taobao.org] site is a mirror which hosts different software assets. Among them, it hosts *chromedriver*, *geckodriver*,  *operadriver*, and *phantomjs* driver. Therefore, this method can be used in ``ChromeDriverManager``, ``FirefoxDriverManager``, ``OperaDriverManager``, and ``PhantomJsDriverManager`` to force to use the taobao.org mirror. | TODO                                                                                                                                                                      |
| ``proxy(String proxy)``                                   | Use a HTTP proxy for the Internet connection.                                                                                                                                                                                                                                                                                                                   | TODO                                                                                                                                                                      |
| ``proxyUser(String username)``                            | Specify a username for HTTP proxy.                                                                                                                                                                                                                                                                                                                              | TODO                                                                                                                                                                      |
| ``proxyPass(String password)``                            | Specify a password for HTTP proxy.                                                                                                                                                                                                                                                                                                                              | TODO                                                                                                                                                                      |
